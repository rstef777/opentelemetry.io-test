...
aliases: [automatic]
---
## Introduction to zero-code instrumentation
As an [ops user](/docs/getting-started/ops/), you might want to add observability to one
...
## Requirements
Before you can begin using zero-code instrumentation, verify that you have configured a service name. The service name is needed to identify the service in your observability backend.
...
passed to initialization methods. 
